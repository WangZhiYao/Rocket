 ...
 * @since 2023/2/10
 */
class ObserveSimpleCharacterListByAccountIdUseCase @Inject constructor(
    private val characterRepository: CharacterRepository,
    @IODispatcher private val dispatcher: CoroutineDispatcher
) {

    operator fun invoke(accountId: Long): Flow<List<SimpleCharacter>> =
        characterRepository.observeSimpleCharacterListByAccountId(accountId).flowOn(dispatcher)
