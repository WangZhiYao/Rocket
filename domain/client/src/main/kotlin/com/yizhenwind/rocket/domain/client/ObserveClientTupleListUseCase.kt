 ...
 * @since 2023/2/9
 */
class ObserveClientTupleListUseCase @Inject constructor(
    private val clientRepository: ClientRepository,
    @IODispatcher private val dispatcher: CoroutineDispatcher
) {

    operator fun invoke(): Flow<List<ClientTuple>> =
        clientRepository.observeClientTupleList().flowOn(dispatcher)
